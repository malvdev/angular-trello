...
import { listAdapter, ListPartialState, initialListState } from './list.reducer';
import * as ListSelectors from './list.selectors';

describe('List Selectors', () => {
  const ERROR_MSG = 'No Error Available';
  const getListId = (it: ListEntity) => it.id;
  ...
  describe('List Selectors', () => {
    ...
    it('getSelected() should return the selected Entity', () => {
      const result = ListSelectors.getSelected(state) as ListEntity;
